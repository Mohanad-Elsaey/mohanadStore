                            ...
                            <div className="pt-8 border-t border-surface-container-low space-y-6">
                                ...
                                <div className="grid gap-4">
                                    {formData.variants.map((variant, idx) => (
                                        <div key={idx} className="grid grid-cols-[auto_1fr_1fr_1fr_auto] gap-4 p-4 bg-surface-container-highest rounded-2xl items-center border border-outline-variant/10 shadow-[inset_0_2px_4px_rgba(0,0,0,0.02)]">
                                            ...
                                            <div className="bg-surface-container-low flex items-center px-1 rounded-lg">
                                                ...
                                                >
                                                    ...
                                                    <option value="material">Phase</option>
                                                </select>
                                            </div>
                                            ...
                                            <div>
                                                <input 
                                                    ...
                                                    className="w-full bg-surface-container-low border-none rounded-lg py-2.5 px-4 text-xs font-bold text-on-surface outline-none placeholder:text-on-surface-variant/40 focus:ring-2 focus:ring-primary/20"
                                                />
                                            </div>
                                            ...
                                            <button 
                                                ...
                                                className="w-8 h-8 flex items-center justify-center bg-error-container/50 text-error hover:bg-error hover:text-on-error rounded-lg transition-all"
                                            >
